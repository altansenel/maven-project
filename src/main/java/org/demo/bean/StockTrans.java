...
public class StockTrans implements Serializable {
    ...
    public void setRefDepotId( Integer refDepotId ) {
        this.refDepotId = refDepotId;
    }
    public Integer getRefDepotId() {
        return this.refDepotId;
    }
