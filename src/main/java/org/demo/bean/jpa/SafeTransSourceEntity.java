...
@Entity
@Table(name="safe_trans_source", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="SafeTransSourceEntity.countAll", query="SELECT COUNT(x) FROM SafeTransSourceEntity x" )
} )
public class SafeTransSourceEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="safeTransSource", targetEntity=SafeTransEntity.class)
