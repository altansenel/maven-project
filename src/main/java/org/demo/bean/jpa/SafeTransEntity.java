...
@Entity
@Table(name="safe_trans", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="SafeTransEntity.countAll", query="SELECT COUNT(x) FROM SafeTransEntity x" )
} )
public class SafeTransEntity implements Serializable {
    ...
    private SafeExpenseEntity safeExpense ;
    ...
    private SafeTransSourceEntity safeTransSource;

    @OneToMany(mappedBy="safeTrans", targetEntity=ChqbllDetailPartialEntity.class)
    ...
    public void setSafeExpense( SafeExpenseEntity safeExpense ) {
        this.safeExpense = safeExpense;
    }
    public SafeExpenseEntity getSafeExpense() {
    ...
    public void setSafeTransSource( SafeTransSourceEntity safeTransSource ) {
        this.safeTransSource = safeTransSource;
    }
    public SafeTransSourceEntity getSafeTransSource() {
