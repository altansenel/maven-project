...
@NamedQueries ( {
  @NamedQuery ( name="StockPriceUpdateEntity.countAll", query="SELECT COUNT(x) FROM StockPriceUpdateEntity x" )
} )
public class StockPriceUpdateEntity implements Serializable {
    ...
    @OneToMany(mappedBy="stockPriceUpdate", targetEntity=StockPriceUpdateDetailEntity.class)
    private List<StockPriceUpdateDetailEntity> listOfStockPriceUpdateDetail;
    ...
    public void setListOfStockPriceUpdateDetail( List<StockPriceUpdateDetailEntity> listOfStockPriceUpdateDetail ) {
        this.listOfStockPriceUpdateDetail = listOfStockPriceUpdateDetail;
    }
    public List<StockPriceUpdateDetailEntity> getListOfStockPriceUpdateDetail() {
