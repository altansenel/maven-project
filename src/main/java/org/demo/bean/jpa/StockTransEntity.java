...
@NamedQueries ( {
  @NamedQuery ( name="StockTransEntity.countAll", query="SELECT COUNT(x) FROM StockTransEntity x" )
} )
public class StockTransEntity implements Serializable {
    ...
    @OneToMany(mappedBy="stockTrans", targetEntity=StockTransFactorEntity.class)
    private List<StockTransFactorEntity> listOfStockTransFactor;

    @ManyToOne
    @JoinColumn(name="ref_depot_id", referencedColumnName="id")
    private StockDepotEntity stockDepot2 ;

    @OneToMany(mappedBy="stockTrans", targetEntity=StockTransDetailEntity.class)
    ...
    @OneToMany(mappedBy="stockTrans", targetEntity=StockTransCurrencyEntity.class)
    private List<StockTransCurrencyEntity> listOfStockTransCurrency;

    @ManyToOne
    @JoinColumn(name="seller_id", referencedColumnName="id")
    private SaleSellerEntity saleSeller  ;

    @OneToMany(mappedBy="stockTrans", targetEntity=StockTransTaxEntity.class)
    private List<StockTransTaxEntity> listOfStockTransTax;
    ...
    public void setStockDepot2( StockDepotEntity stockDepot2 ) {
        this.stockDepot2 = stockDepot2;
    }
    public StockDepotEntity getStockDepot2() {
    ...
    public void setListOfStockTransCurrency( List<StockTransCurrencyEntity> listOfStockTransCurrency ) {
        this.listOfStockTransCurrency = listOfStockTransCurrency;
    }
    public List<StockTransCurrencyEntity> getListOfStockTransCurrency() {
    ...
    public void setListOfStockTransTax( List<StockTransTaxEntity> listOfStockTransTax ) {
        this.listOfStockTransTax = listOfStockTransTax;
    }
    public List<StockTransTaxEntity> getListOfStockTransTax() {
