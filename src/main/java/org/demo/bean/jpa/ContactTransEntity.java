...
@Entity
@Table(name="contact_trans", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="ContactTransEntity.countAll", query="SELECT COUNT(x) FROM ContactTransEntity x" )
} )
public class ContactTransEntity implements Serializable {
    ...
    private ContactTransSourceEntity contactTransSource;
    ...
    //----------------------------------------------------------------------
    public void setContactTransSource( ContactTransSourceEntity contactTransSource ) {
        this.contactTransSource = contactTransSource;
    }
    public ContactTransSourceEntity getContactTransSource() {
