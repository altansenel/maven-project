...
@Entity
@Table(name="safe_expense", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="SafeExpenseEntity.countAll", query="SELECT COUNT(x) FROM SafeExpenseEntity x" )
} )
public class SafeExpenseEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="safeExpense", targetEntity=SafeTransEntity.class)
