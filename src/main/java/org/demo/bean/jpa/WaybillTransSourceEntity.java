...
@Entity
@Table(name="waybill_trans_source", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="WaybillTransSourceEntity.countAll", query="SELECT COUNT(x) FROM WaybillTransSourceEntity x" )
} )
public class WaybillTransSourceEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="waybillTransSource", targetEntity=WaybillTransEntity.class)
    private List<WaybillTransEntity> listOfWaybillTrans;

    @OneToMany(mappedBy="waybillTransSource", targetEntity=WaybillTransDetailEntity.class)
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public WaybillTransSourceEntity() {
		super();
    }
