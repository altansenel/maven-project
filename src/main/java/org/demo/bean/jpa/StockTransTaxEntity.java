...
@Entity
@Table(name="stock_trans_tax", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="StockTransTaxEntity.countAll", query="SELECT COUNT(x) FROM StockTransTaxEntity x" )
} )
public class StockTransTaxEntity implements Serializable {
