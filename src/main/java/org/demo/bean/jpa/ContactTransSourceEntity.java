...
@Entity
@Table(name="contact_trans_source", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="ContactTransSourceEntity.countAll", query="SELECT COUNT(x) FROM ContactTransSourceEntity x" )
} )
public class ContactTransSourceEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="contactTransSource", targetEntity=ContactTransEntity.class)
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public ContactTransSourceEntity() {
		super();
    }
