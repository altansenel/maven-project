...
@Entity
@Table(name="order_trans_source", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="OrderTransSourceEntity.countAll", query="SELECT COUNT(x) FROM OrderTransSourceEntity x" )
} )
public class OrderTransSourceEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="orderTransSource", targetEntity=OrderTransEntity.class)
    private List<OrderTransEntity> listOfOrderTrans;

    @OneToMany(mappedBy="orderTransSource", targetEntity=OrderTransDetailEntity.class)
