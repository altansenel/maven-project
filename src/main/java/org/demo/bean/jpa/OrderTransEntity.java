...
@Entity
@Table(name="order_trans", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="OrderTransEntity.countAll", query="SELECT COUNT(x) FROM OrderTransEntity x" )
} )
public class OrderTransEntity implements Serializable {
    ...
    @OneToMany(mappedBy="orderTrans", targetEntity=OrderTransFactorEntity.class)
    ...
    @OneToMany(mappedBy="orderTrans", targetEntity=OrderTransDetailEntity.class)
