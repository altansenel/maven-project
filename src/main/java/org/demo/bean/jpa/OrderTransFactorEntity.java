...
@Entity
@Table(name="order_trans_factor", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="OrderTransFactorEntity.countAll", query="SELECT COUNT(x) FROM OrderTransFactorEntity x" )
} )
public class OrderTransFactorEntity implements Serializable {
