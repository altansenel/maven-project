...
@Entity
@Table(name="global_currency", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="GlobalCurrencyEntity.countAll", query="SELECT COUNT(x) FROM GlobalCurrencyEntity x" )
} )
public class GlobalCurrencyEntity implements Serializable {
