...
@Entity
@Table(name="stock_unit", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="StockUnitEntity.countAll", query="SELECT COUNT(x) FROM StockUnitEntity x" )
} )
public class StockUnitEntity implements Serializable {
