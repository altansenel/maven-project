...
@NamedQueries ( {
  @NamedQuery ( name="GlobalTransPointEntity.countAll", query="SELECT COUNT(x) FROM GlobalTransPointEntity x" )
} )
public class GlobalTransPointEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="globalTransPoint", targetEntity=ChqbllPayrollDetailEntity.class)
    private List<ChqbllPayrollDetailEntity> listOfChqbllPayrollDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=OrderTransDetailEntity.class)
    private List<OrderTransDetailEntity> listOfOrderTransDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=StockCostingEntity.class)
    private List<StockCostingEntity> listOfStockCosting;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=InvoiceTransEntity.class)
    private List<InvoiceTransEntity> listOfInvoiceTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=StockTransDetailEntity.class)
    private List<StockTransDetailEntity> listOfStockTransDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=ChqbllPayrollEntity.class)
    private List<ChqbllPayrollEntity> listOfChqbllPayroll;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=ContactTransEntity.class)
    private List<ContactTransEntity> listOfContactTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=OrderTransEntity.class)
    private List<OrderTransEntity> listOfOrderTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=ChqbllTransEntity.class)
    private List<ChqbllTransEntity> listOfChqbllTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=InvoiceTransDetailEntity.class)
    private List<InvoiceTransDetailEntity> listOfInvoiceTransDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=StockTransEntity.class)
    private List<StockTransEntity> listOfStockTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=BankTransEntity.class)
    private List<BankTransEntity> listOfBankTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=WaybillTransDetailEntity.class)
    private List<WaybillTransDetailEntity> listOfWaybillTransDetail;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=WaybillTransEntity.class)
    private List<WaybillTransEntity> listOfWaybillTrans;

    @OneToMany(mappedBy="globalTransPoint", targetEntity=SafeTransEntity.class)
