...
@Entity
@Table(name="invoice_trans_factor", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="InvoiceTransFactorEntity.countAll", query="SELECT COUNT(x) FROM InvoiceTransFactorEntity x" )
} )
public class InvoiceTransFactorEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public InvoiceTransFactorEntity() {
		super();
    }
