...
@Entity
@Table(name="waybill_trans_detail", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="WaybillTransDetailEntity.countAll", query="SELECT COUNT(x) FROM WaybillTransDetailEntity x" )
} )
public class WaybillTransDetailEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public WaybillTransDetailEntity() {
		super();
    }
