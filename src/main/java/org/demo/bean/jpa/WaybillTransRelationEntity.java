...
@NamedQueries ( {
  @NamedQuery ( name="WaybillTransRelationEntity.countAll", query="SELECT COUNT(x) FROM WaybillTransRelationEntity x" )
} )
public class WaybillTransRelationEntity implements Serializable {
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public WaybillTransRelationEntity() {
		super();
    }
