...
@Entity
@Table(name="stock_trans_source", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="StockTransSourceEntity.countAll", query="SELECT COUNT(x) FROM StockTransSourceEntity x" )
} )
public class StockTransSourceEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="stockTransSource", targetEntity=StockTransEntity.class)
    private List<StockTransEntity> listOfStockTrans;

    @OneToMany(mappedBy="stockTransSource", targetEntity=StockTransDetailEntity.class)
