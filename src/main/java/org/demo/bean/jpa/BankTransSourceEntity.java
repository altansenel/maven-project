...
@Entity
@Table(name="bank_trans_source", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="BankTransSourceEntity.countAll", query="SELECT COUNT(x) FROM BankTransSourceEntity x" )
} )
public class BankTransSourceEntity implements Serializable {
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="bankTransSource", targetEntity=BankTransEntity.class)
