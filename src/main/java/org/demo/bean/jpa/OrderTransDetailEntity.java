...
@Entity
@Table(name="order_trans_detail", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="OrderTransDetailEntity.countAll", query="SELECT COUNT(x) FROM OrderTransDetailEntity x" )
} )
public class OrderTransDetailEntity implements Serializable {
    ...
    private OrderTransEntity orderTrans  ;

    @ManyToOne
    @JoinColumn(name="trans_source_id", referencedColumnName="id")
    private OrderTransSourceEntity orderTransSource;
    ...
    public void setOrderTrans( OrderTransEntity orderTrans ) {
        this.orderTrans = orderTrans;
    }
    public OrderTransEntity getOrderTrans() {
        return this.orderTrans;
    }

    public void setOrderTransSource( OrderTransSourceEntity orderTransSource ) {
        this.orderTransSource = orderTransSource;
    }
    public OrderTransSourceEntity getOrderTransSource() {
