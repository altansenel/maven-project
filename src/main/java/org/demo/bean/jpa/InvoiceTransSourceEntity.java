...
@Entity
@Table(name="invoice_trans_source", catalog="seyhan" )
// Define named queries here
@NamedQueries ( {
  @NamedQuery ( name="InvoiceTransSourceEntity.countAll", query="SELECT COUNT(x) FROM InvoiceTransSourceEntity x" )
} )
public class InvoiceTransSourceEntity implements Serializable {
    ...
    @Column(name="has_stock_effect")
    private Boolean    hasStockEffect ;
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="invoiceTransSource", targetEntity=InvoiceTransDetailEntity.class)
    private List<InvoiceTransDetailEntity> listOfInvoiceTransDetail;

    @OneToMany(mappedBy="invoiceTransSource", targetEntity=InvoiceTransEntity.class)
    ...
    // CONSTRUCTOR(S)
    //----------------------------------------------------------------------
    public InvoiceTransSourceEntity() {
		super();
    }
