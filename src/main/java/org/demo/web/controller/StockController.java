...
public class StockController extends AbstractController {
	...
	private static final String MAIN_ENTITY_NAME = "stock";
	private static final String MAIN_LIST_NAME   = "list";

	//--- JSP pages names ( View name in the MVC model )
	private static final String JSP_FORM   = "stock/form";
	private static final String JSP_LIST   = "stock/list";

	//--- SAVE ACTION ( in the HTML form )
	private static final String SAVE_ACTION_CREATE   = "/stock/create";
	private static final String SAVE_ACTION_UPDATE   = "/stock/update";
	...
	public StockController() {
		super(StockController.class, MAIN_ENTITY_NAME );
		log("StockController created.");
	}
	 ...
	 * @param stock
	 */
	private void populateModel(Model model, Stock stock, FormMode formMode) {
		//--- Main entity
		model.addAttribute(MAIN_ENTITY_NAME, stock);
	...
	//--------------------------------------------------------------------------------------
	/**
	 * Shows a list with all the occurrences of Stock found in the database
	...
	/**
	 * Shows a form page in order to create a new Stock
	 * @param model Spring MVC model
	 * @return
	 */
	@RequestMapping("/form")
	public String formForCreate(Model model) {
		...
		populateModel( model, stock, FormMode.CREATE);
		return JSP_FORM;
	}

	/**
	 * Shows a form page in order to update an existing Stock
	 * @param model Spring MVC model
	...
	public String formForUpdate(Model model, @PathVariable("id") Integer id ) {
		...
		populateModel( model, stock, FormMode.UPDATE);		
		return JSP_FORM;
	}
	 ...
	 * @param stock  entity to be created
	...
	public String create(@Valid Stock stock, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes, HttpServletRequest httpServletRequest) {
		log("Action 'create'");
		try {
			if (!bindingResult.hasErrors()) {
				Stock stockCreated = stockService.create(stock); 
				model.addAttribute(MAIN_ENTITY_NAME, stockCreated);

				//---
				messageHelper.addMessage(redirectAttributes, new Message(MessageType.SUCCESS,"save.ok"));
				return redirectToForm(httpServletRequest, stock.getId() );
			} else {
				populateModel( model, stock, FormMode.CREATE);
				return JSP_FORM;
			}
			...
			messageHelper.addException(model, "stock.error.create", e);
			populateModel( model, stock, FormMode.CREATE);
			return JSP_FORM;
		}
	}
	 ...
	 * This action is based on the 'Post/Redirect/Get (PRG)' pattern, so it ends by 'http redirect'<br>
	 * @param stock  entity to be updated
	 * @param bindingResult Spring MVC binding result
	 * @param model Spring MVC model
	 * @param redirectAttributes Spring MVC redirect attributes
	 * @param httpServletRequest
	...
	public String update(@Valid Stock stock, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes, HttpServletRequest httpServletRequest) {
		log("Action 'update'");
		try {
			if (!bindingResult.hasErrors()) {
				//--- Perform database operations
				Stock stockSaved = stockService.update(stock);
				model.addAttribute(MAIN_ENTITY_NAME, stockSaved);
			...
			messageHelper.addException(model, "stock.error.update", e);
	...
	public String delete(RedirectAttributes redirectAttributes, @PathVariable("id") Integer id) {
		...
		try {
			...
			messageHelper.addException(redirectAttributes, "stock.error.delete", e);
		}
