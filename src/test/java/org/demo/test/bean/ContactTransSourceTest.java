/*
 * JUnit test case for bean ContactTransSource
 ...
 *
 */
public class ContactTransSourceTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class ContactTransSource getters and setters ..." );
		...
		contactTransSource.setId( integerValue ) ;
		Assert.assertTrue( integerValue == contactTransSource.getId() ) ;

		//--- Test setter/getter for field "name"  ( type : String )
		// System.out.println(" checking field name ..." );
		contactTransSource.setName( stringValue ) ;
		Assert.assertTrue( stringValue.equals( contactTransSource.getName() ) ) ;

		//--- Test setter/getter for field "suitableRight"  ( type : String )
		// System.out.println(" checking field suitableRight ..." );
		contactTransSource.setSuitableRight( stringValue ) ;
		Assert.assertTrue( stringValue.equals( contactTransSource.getSuitableRight() ) ) ;

		//--- Test setter/getter for field "insertBy"  ( type : String )
		// System.out.println(" checking field insertBy ..." );
		contactTransSource.setInsertBy( stringValue ) ;
		Assert.assertTrue( stringValue.equals( contactTransSource.getInsertBy() ) ) ;

		//--- Test setter/getter for field "insertAt"  ( type : Date )
		// System.out.println(" checking field insertAt ..." );
		contactTransSource.setInsertAt( dateValue ) ;
		Assert.assertTrue( dateValue.equals( contactTransSource.getInsertAt() ) );

		//--- Test setter/getter for field "updateBy"  ( type : String )
		// System.out.println(" checking field updateBy ..." );
		contactTransSource.setUpdateBy( stringValue ) ;
		Assert.assertTrue( stringValue.equals( contactTransSource.getUpdateBy() ) ) ;

		//--- Test setter/getter for field "updateAt"  ( type : Date )
		// System.out.println(" checking field updateAt ..." );
		contactTransSource.setUpdateAt( dateValue ) ;
		Assert.assertTrue( dateValue.equals( contactTransSource.getUpdateAt() ) );

		//--- Test setter/getter for field "isActive"  ( type : Boolean )
		// System.out.println(" checking field isActive ..." );
		contactTransSource.setIsActive( true ) ;
		Assert.assertTrue( contactTransSource.getIsActive() ) ;
		contactTransSource.setIsActive( false ) ;
		Assert.assertFalse( contactTransSource.getIsActive() ) ;

		//--- Test setter/getter for field "workspace"  ( type : Integer )
		// System.out.println(" checking field workspace ..." );
		contactTransSource.setWorkspace( integerValue ) ;
		Assert.assertTrue( integerValue == contactTransSource.getWorkspace() ) ;

		//--- Test setter/getter for field "version"  ( type : Integer )
		// System.out.println(" checking field version ..." );
		contactTransSource.setVersion( integerValue ) ;
		Assert.assertTrue( integerValue == contactTransSource.getVersion() ) ;
