/*
 * JUnit test case for bean InvoiceTransRelation
 ...
 *
 */
public class InvoiceTransRelationTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class InvoiceTransRelation getters and setters ..." );
		...
		invoiceTransRelation.setId( integerValue ) ;
		Assert.assertTrue( integerValue == invoiceTransRelation.getId() ) ;

		//--- Test setter/getter for field "relId"  ( type : Integer )
		// System.out.println(" checking field relId ..." );
		invoiceTransRelation.setRelId( integerValue ) ;
		Assert.assertTrue( integerValue == invoiceTransRelation.getRelId() ) ;

		//--- Test setter/getter for field "relRight"  ( type : String )
		// System.out.println(" checking field relRight ..." );
		invoiceTransRelation.setRelRight( stringValue ) ;
		Assert.assertTrue( stringValue.equals( invoiceTransRelation.getRelRight() ) ) ;

		//--- Test setter/getter for field "relReceiptNo"  ( type : Integer )
		// System.out.println(" checking field relReceiptNo ..." );
		invoiceTransRelation.setRelReceiptNo( integerValue ) ;
		Assert.assertTrue( integerValue == invoiceTransRelation.getRelReceiptNo() ) ;

		//--- Test setter/getter for field "transId"  ( type : Integer )
		// System.out.println(" checking field transId ..." );
		invoiceTransRelation.setTransId( integerValue ) ;
		Assert.assertTrue( integerValue == invoiceTransRelation.getTransId() ) ;
