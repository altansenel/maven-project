/*
 * JUnit test case for bean BankTransSource
 ...
 *
 */
public class BankTransSourceTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class BankTransSource getters and setters ..." );
		...
		bankTransSource.setId( integerValue ) ;
		Assert.assertTrue( integerValue == bankTransSource.getId() ) ;

		//--- Test setter/getter for field "name"  ( type : String )
		// System.out.println(" checking field name ..." );
		bankTransSource.setName( stringValue ) ;
		Assert.assertTrue( stringValue.equals( bankTransSource.getName() ) ) ;

		//--- Test setter/getter for field "suitableRight"  ( type : String )
		// System.out.println(" checking field suitableRight ..." );
		bankTransSource.setSuitableRight( stringValue ) ;
		Assert.assertTrue( stringValue.equals( bankTransSource.getSuitableRight() ) ) ;

		//--- Test setter/getter for field "insertBy"  ( type : String )
		// System.out.println(" checking field insertBy ..." );
		bankTransSource.setInsertBy( stringValue ) ;
		Assert.assertTrue( stringValue.equals( bankTransSource.getInsertBy() ) ) ;

		//--- Test setter/getter for field "insertAt"  ( type : Date )
		// System.out.println(" checking field insertAt ..." );
		bankTransSource.setInsertAt( dateValue ) ;
		Assert.assertTrue( dateValue.equals( bankTransSource.getInsertAt() ) );

		//--- Test setter/getter for field "updateBy"  ( type : String )
		// System.out.println(" checking field updateBy ..." );
		bankTransSource.setUpdateBy( stringValue ) ;
		Assert.assertTrue( stringValue.equals( bankTransSource.getUpdateBy() ) ) ;

		//--- Test setter/getter for field "updateAt"  ( type : Date )
		// System.out.println(" checking field updateAt ..." );
		bankTransSource.setUpdateAt( dateValue ) ;
		Assert.assertTrue( dateValue.equals( bankTransSource.getUpdateAt() ) );

		//--- Test setter/getter for field "isActive"  ( type : Boolean )
		// System.out.println(" checking field isActive ..." );
		bankTransSource.setIsActive( true ) ;
		Assert.assertTrue( bankTransSource.getIsActive() ) ;
		bankTransSource.setIsActive( false ) ;
		Assert.assertFalse( bankTransSource.getIsActive() ) ;

		//--- Test setter/getter for field "workspace"  ( type : Integer )
		// System.out.println(" checking field workspace ..." );
		bankTransSource.setWorkspace( integerValue ) ;
		Assert.assertTrue( integerValue == bankTransSource.getWorkspace() ) ;

		//--- Test setter/getter for field "version"  ( type : Integer )
		// System.out.println(" checking field version ..." );
		bankTransSource.setVersion( integerValue ) ;
		Assert.assertTrue( integerValue == bankTransSource.getVersion() ) ;
