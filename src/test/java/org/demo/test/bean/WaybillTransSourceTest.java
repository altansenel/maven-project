/*
 * JUnit test case for bean WaybillTransSource
 ...
 *
 */
public class WaybillTransSourceTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class WaybillTransSource getters and setters ..." );
		...
		waybillTransSource.setId( integerValue ) ;
		Assert.assertTrue( integerValue == waybillTransSource.getId() ) ;

		//--- Test setter/getter for field "name"  ( type : String )
		// System.out.println(" checking field name ..." );
		waybillTransSource.setName( stringValue ) ;
		Assert.assertTrue( stringValue.equals( waybillTransSource.getName() ) ) ;

		//--- Test setter/getter for field "suitableRight"  ( type : String )
		// System.out.println(" checking field suitableRight ..." );
		waybillTransSource.setSuitableRight( stringValue ) ;
		Assert.assertTrue( stringValue.equals( waybillTransSource.getSuitableRight() ) ) ;

		//--- Test setter/getter for field "insertBy"  ( type : String )
		// System.out.println(" checking field insertBy ..." );
		waybillTransSource.setInsertBy( stringValue ) ;
		Assert.assertTrue( stringValue.equals( waybillTransSource.getInsertBy() ) ) ;

		//--- Test setter/getter for field "insertAt"  ( type : Date )
		// System.out.println(" checking field insertAt ..." );
		waybillTransSource.setInsertAt( dateValue ) ;
		Assert.assertTrue( dateValue.equals( waybillTransSource.getInsertAt() ) );

		//--- Test setter/getter for field "updateBy"  ( type : String )
		// System.out.println(" checking field updateBy ..." );
		waybillTransSource.setUpdateBy( stringValue ) ;
		Assert.assertTrue( stringValue.equals( waybillTransSource.getUpdateBy() ) ) ;

		//--- Test setter/getter for field "updateAt"  ( type : Date )
		// System.out.println(" checking field updateAt ..." );
		waybillTransSource.setUpdateAt( dateValue ) ;
		Assert.assertTrue( dateValue.equals( waybillTransSource.getUpdateAt() ) );

		//--- Test setter/getter for field "isActive"  ( type : Boolean )
		// System.out.println(" checking field isActive ..." );
		waybillTransSource.setIsActive( true ) ;
		Assert.assertTrue( waybillTransSource.getIsActive() ) ;
		waybillTransSource.setIsActive( false ) ;
		Assert.assertFalse( waybillTransSource.getIsActive() ) ;

		//--- Test setter/getter for field "workspace"  ( type : Integer )
		// System.out.println(" checking field workspace ..." );
		waybillTransSource.setWorkspace( integerValue ) ;
		Assert.assertTrue( integerValue == waybillTransSource.getWorkspace() ) ;

		//--- Test setter/getter for field "version"  ( type : Integer )
		// System.out.println(" checking field version ..." );
		waybillTransSource.setVersion( integerValue ) ;
		Assert.assertTrue( integerValue == waybillTransSource.getVersion() ) ;
