/*
 * JUnit test case for bean WaybillTransStatusHistory
 ...
 *
 */
public class WaybillTransStatusHistoryTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class WaybillTransStatusHistory getters and setters ..." );
		...
		waybillTransStatusHistory.setId( integerValue ) ;
		Assert.assertTrue( integerValue == waybillTransStatusHistory.getId() ) ;

		//--- Test setter/getter for field "transTime"  ( type : Date )
		// System.out.println(" checking field transTime ..." );
		waybillTransStatusHistory.setTransTime( dateValue ) ;
		Assert.assertTrue( dateValue.equals( waybillTransStatusHistory.getTransTime() ) );

		//--- Test setter/getter for field "transId"  ( type : Integer )
		// System.out.println(" checking field transId ..." );
		waybillTransStatusHistory.setTransId( integerValue ) ;
		Assert.assertTrue( integerValue == waybillTransStatusHistory.getTransId() ) ;

		//--- Test setter/getter for field "statusId"  ( type : Integer )
		// System.out.println(" checking field statusId ..." );
		waybillTransStatusHistory.setStatusId( integerValue ) ;
		Assert.assertTrue( integerValue == waybillTransStatusHistory.getStatusId() ) ;

		//--- Test setter/getter for field "username"  ( type : String )
		// System.out.println(" checking field username ..." );
		waybillTransStatusHistory.setUsername( stringValue ) ;
		Assert.assertTrue( stringValue.equals( waybillTransStatusHistory.getUsername() ) ) ;

		//--- Test setter/getter for field "description"  ( type : String )
		// System.out.println(" checking field description ..." );
		waybillTransStatusHistory.setDescription( stringValue ) ;
		Assert.assertTrue( stringValue.equals( waybillTransStatusHistory.getDescription() ) ) ;
