/*
 * JUnit test case for bean InvoiceTransCurrency
 ...
 *
 */
public class InvoiceTransCurrencyTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class InvoiceTransCurrency getters and setters ..." );
		...
		invoiceTransCurrency.setId( integerValue ) ;
		Assert.assertTrue( integerValue == invoiceTransCurrency.getId() ) ;

		//--- Test setter/getter for field "currency"  ( type : String )
		// System.out.println(" checking field currency ..." );
		invoiceTransCurrency.setCurrency( stringValue ) ;
		Assert.assertTrue( stringValue.equals( invoiceTransCurrency.getCurrency() ) ) ;

		//--- Test setter/getter for field "amount"  ( type : Double )
		// System.out.println(" checking field amount ..." );
		invoiceTransCurrency.setAmount( doubleValue ) ;
		Assert.assertTrue( doubleValue == invoiceTransCurrency.getAmount() ) ;

		//--- Test setter/getter for field "transId"  ( type : Integer )
		// System.out.println(" checking field transId ..." );
		invoiceTransCurrency.setTransId( integerValue ) ;
		Assert.assertTrue( integerValue == invoiceTransCurrency.getTransId() ) ;
