/*
 * JUnit test case for bean ContactExtraFields
...
public class ContactExtraFieldsTest 
{
	...
	public void testSettersAndGetters() {
		...
		System.out.println("Checking class ContactExtraFields getters and setters ..." );
		...
		contactExtraFields.setId( integerValue ) ;
		Assert.assertTrue( integerValue == contactExtraFields.getId() ) ;

		//--- Test setter/getter for field "name"  ( type : String )
		// System.out.println(" checking field name ..." );
		contactExtraFields.setName( stringValue ) ;
		Assert.assertTrue( stringValue.equals( contactExtraFields.getName() ) ) ;

		//--- Test setter/getter for field "insertBy"  ( type : String )
		// System.out.println(" checking field insertBy ..." );
		contactExtraFields.setInsertBy( stringValue ) ;
		Assert.assertTrue( stringValue.equals( contactExtraFields.getInsertBy() ) ) ;

		//--- Test setter/getter for field "insertAt"  ( type : Date )
		// System.out.println(" checking field insertAt ..." );
		contactExtraFields.setInsertAt( dateValue ) ;
		Assert.assertTrue( dateValue.equals( contactExtraFields.getInsertAt() ) );

		//--- Test setter/getter for field "updateBy"  ( type : String )
		// System.out.println(" checking field updateBy ..." );
		contactExtraFields.setUpdateBy( stringValue ) ;
		Assert.assertTrue( stringValue.equals( contactExtraFields.getUpdateBy() ) ) ;

		//--- Test setter/getter for field "updateAt"  ( type : Date )
		// System.out.println(" checking field updateAt ..." );
		contactExtraFields.setUpdateAt( dateValue ) ;
		Assert.assertTrue( dateValue.equals( contactExtraFields.getUpdateAt() ) );

		//--- Test setter/getter for field "isActive"  ( type : Boolean )
		// System.out.println(" checking field isActive ..." );
		contactExtraFields.setIsActive( true ) ;
		Assert.assertTrue( contactExtraFields.getIsActive() ) ;
		contactExtraFields.setIsActive( false ) ;
		Assert.assertFalse( contactExtraFields.getIsActive() ) ;

		//--- Test setter/getter for field "extraFieldsId"  ( type : Integer )
		// System.out.println(" checking field extraFieldsId ..." );
		contactExtraFields.setExtraFieldsId( integerValue ) ;
		Assert.assertTrue( integerValue == contactExtraFields.getExtraFieldsId() ) ;

		//--- Test setter/getter for field "workspace"  ( type : Integer )
		// System.out.println(" checking field workspace ..." );
		contactExtraFields.setWorkspace( integerValue ) ;
		Assert.assertTrue( integerValue == contactExtraFields.getWorkspace() ) ;

		//--- Test setter/getter for field "version"  ( type : Integer )
		// System.out.println(" checking field version ..." );
		contactExtraFields.setVersion( integerValue ) ;
		Assert.assertTrue( integerValue == contactExtraFields.getVersion() ) ;
