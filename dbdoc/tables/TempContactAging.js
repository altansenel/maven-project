...
var uml = joint.shapes.uml;
   ...
   var classes = {  
temp_contact_aging: new uml.BDDTable({
		id:'temp_contact_aging',
        position: { x:450  , y: 350 },
        size: { width: 180, height: 171 },
        name: 'temp_contact_aging',
        attributes: [
																																																																																			],
        methods: [
										'username: VARCHAR(20)',
...
_.each(classes, function(c) { graph.addCell(c); });
 ...
 function saveGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		localStorage.jsonTempContactAgingGraph=(JSON.stringify(graph.toJSON()));
  	}
	else
  	{
 ...
 function loadGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		 graph.fromJSON(JSON.parse(localStorage.jsonTempContactAgingGraph));
  	}
	else
  	{
  		document.getElementById("error").innerHTML="Sorry, your browser does not support web storage...";
