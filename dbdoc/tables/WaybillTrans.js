...
waybill_trans: new uml.BDDTable({
        ...
        methods: [
						...
						waybill_trans_source: new uml.BDDTable({
		id:'waybill_trans_source',
        position: { x:561.2461179749811  , y: 7.619654133744746 },
        size: { width: 220, height: 170 },
        name: 'waybill_trans_source',
        attributes: [
										'id: INT',
																																																																									],
        methods: [
        ...
        methods: [
						...
						waybill_trans_status: new uml.BDDTable({
		id:'waybill_trans_status',
        position: { x:158.75388202501892  , y: 561.6026908252903 },
        size: { width: 220, height: 181 },
        name: 'waybill_trans_status',
        attributes: [
										'id: INT',
																																																																																],
        methods: [
        ...
        methods: [
								...
								waybill_trans_relation: new uml.BDDTable({
		id:'waybill_trans_relation',
        position: { x:741.246117974981  , y: 561.6026908252904 },
        size: { width: 220, height: 115 },
        name: 'waybill_trans_relation',
        attributes: [
										'id: INT',
																																						],
        methods: [
...
var relations = [
	...
	{ position: 60, attrs: { text: { text: 'waybill_trans_ibfk_2' } }}
		...
		new joint.dia.Link({
	source: { id: classes.waybill_trans.id },
	target: { id: classes.waybill_trans_source.id },
	vertices: [],
	smooth: false,
	attrs: {
	'.marker-target': { d: 'M 20 0 L 0 5 L 20 10 z' }
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'waybill_trans_ibfk_3' } }}
	]
}),	
		new joint.dia.Link({
	source: { id: classes.waybill_trans.id },
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'waybill_trans_ibfk_5' } }}
	]
}),	
		new joint.dia.Link({
	source: { id: classes.waybill_trans.id },
	...
	{ position: 60, attrs: { text: { text: 'waybill_trans_ibfk_6' } }}
		...
		new joint.dia.Link({
	source: { id: classes.waybill_trans.id },
	target: { id: classes.waybill_trans_status.id },
	vertices: [],
	smooth: false,
	attrs: {
	'.marker-target': { d: 'M 20 0 L 0 5 L 20 10 z' }
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'waybill_trans_ibfk_7' } }}
	]
}),	
	 
																																																																																																							new joint.dia.Link({
	source: { id: classes.waybill_trans_detail.id },
	target: { id: classes.waybill_trans.id },
	vertices: [],
	smooth: false,
	attrs: {
	'.marker-target': { d: 'M 20 0 L 0 5 L 20 10 z' }
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'waybill_trans_detail_ibfk_1' } }}
	]
}),	
																																								new joint.dia.Link({
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'waybill_trans_factor_ibfk_1' } }}
	]
}),	
																																																																																																																																																																																																																																																																																																	new joint.dia.Link({
	source: { id: classes.waybill_trans_relation.id },
	target: { id: classes.waybill_trans.id },
	vertices: [],
	smooth: false,
	attrs: {
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'waybill_trans_relation_ibfk_1' } }}
	]
}),	
																																																																																																																																																																																																																																																																																																		];
...
_.each(relations, function(r) { r.toBack(); });
 ...
 function saveGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		localStorage.jsonWaybillTransGraph=(JSON.stringify(graph.toJSON()));
  	}
	else
  	{
 ...
 function loadGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		 graph.fromJSON(JSON.parse(localStorage.jsonWaybillTransGraph));
  	}
	else
  	{
  		document.getElementById("error").innerHTML="Sorry, your browser does not support web storage...";
