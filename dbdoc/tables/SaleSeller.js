...
var relations = [
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'stock_trans_detail_ibfk_5' } }}
	]
}),	
																																																																						new joint.dia.Link({
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'order_trans_ibfk_5' } }}
	]
}),	
																																																																																																															new joint.dia.Link({
...
_.each(relations, function(r) { r.toBack(); });
 ...
 function saveGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		localStorage.jsonSaleSellerGraph=(JSON.stringify(graph.toJSON()));
  	}
	else
  	{
 ...
 function loadGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		 graph.fromJSON(JSON.parse(localStorage.jsonSaleSellerGraph));
  	}
	else
  	{
  		document.getElementById("error").innerHTML="Sorry, your browser does not support web storage...";
