...
var uml = joint.shapes.uml;
   ...
   var classes = {  
global_profile: new uml.BDDTable({
		id:'global_profile',
...
_.each(classes, function(c) { graph.addCell(c); });
 ...
 function saveGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		localStorage.jsonGlobalProfileGraph=(JSON.stringify(graph.toJSON()));
  	}
	else
  	{
 ...
 function loadGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		 graph.fromJSON(JSON.parse(localStorage.jsonGlobalProfileGraph));
  	}
	else
  	{
  		document.getElementById("error").innerHTML="Sorry, your browser does not support web storage...";
