...
invoice_trans: new uml.BDDTable({
        ...
        methods: [
						...
						invoice_trans_source: new uml.BDDTable({
		id:'invoice_trans_source',
        position: { x:630.0  , y: 38.23085463760208 },
        size: { width: 220, height: 192 },
        name: 'invoice_trans_source',
        attributes: [
										'id: INT',
																																																																																							],
        methods: [
        ...
        methods: [
						...
						invoice_trans_status: new uml.BDDTable({
		id:'invoice_trans_status',
        position: { x:90.0  , y: 349.99999999999994 },
        size: { width: 220, height: 181 },
        name: 'invoice_trans_status',
        attributes: [
										'id: INT',
																																																																																],
        methods: [
        ...
        methods: [
								...
								invoice_trans_tax: new uml.BDDTable({
		id:'invoice_trans_tax',
        position: { x:449.99999999999994  , y: 710.0 },
        size: { width: 220, height: 115 },
        name: 'invoice_trans_tax',
        attributes: [
										'id: INT',
																																						],
        methods: [
        ...
        methods: [
								...
								invoice_trans_currency: new uml.BDDTable({
		id:'invoice_trans_currency',
        position: { x:761.7691453623978  , y: 530.0000000000002 },
        size: { width: 220, height: 104 },
        name: 'invoice_trans_currency',
        attributes: [
										'id: INT',
																															],
        methods: [
...
var relations = [
	...
	{ position: 60, attrs: { text: { text: 'invoice_trans_ibfk_2' } }}
		...
		new joint.dia.Link({
	source: { id: classes.invoice_trans.id },
	target: { id: classes.invoice_trans_source.id },
	vertices: [],
	smooth: false,
	attrs: {
	'.marker-target': { d: 'M 20 0 L 0 5 L 20 10 z' }
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'invoice_trans_ibfk_3' } }}
	]
}),	
		new joint.dia.Link({
	source: { id: classes.invoice_trans.id },
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'invoice_trans_ibfk_5' } }}
	]
}),	
		new joint.dia.Link({
	source: { id: classes.invoice_trans.id },
	...
	{ position: 60, attrs: { text: { text: 'invoice_trans_ibfk_6' } }}
		...
		new joint.dia.Link({
	source: { id: classes.invoice_trans.id },
	target: { id: classes.invoice_trans_status.id },
	vertices: [],
	smooth: false,
	attrs: {
	'.marker-target': { d: 'M 20 0 L 0 5 L 20 10 z' }
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'invoice_trans_ibfk_7' } }}
	]
}),	
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'invoice_trans_detail_ibfk_1' } }}
	]
}),	
																																																														new joint.dia.Link({
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'invoice_trans_factor_ibfk_1' } }}
	]
}),	
																																																																																																																																																																																																																																																																																																		new joint.dia.Link({
	source: { id: classes.invoice_trans_tax.id },
	target: { id: classes.invoice_trans.id },
	vertices: [],
	smooth: false,
	attrs: {
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'invoice_trans_tax_ibfk_1' } }}
	]
}),	
																			new joint.dia.Link({
	...
	{ position: 60, attrs: { text: { text: 'invoice_trans_relation_ibfk_1' } }}
																																																																																										...
																																																																																										new joint.dia.Link({
	source: { id: classes.invoice_trans_currency.id },
	target: { id: classes.invoice_trans.id },
	vertices: [],
	smooth: false,
	attrs: {
	...
	labels: [
	{ position: 60, attrs: { text: { text: 'invoice_trans_currency_ibfk_1' } }}
	]
}),	
																																																																																																																																																																																																					];
...
_.each(relations, function(r) { r.toBack(); });
 ...
 function saveGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		localStorage.jsonInvoiceTransGraph=(JSON.stringify(graph.toJSON()));
  	}
	else
  	{
 ...
 function loadGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		 graph.fromJSON(JSON.parse(localStorage.jsonInvoiceTransGraph));
  	}
	else
  	{
  		document.getElementById("error").innerHTML="Sorry, your browser does not support web storage...";
