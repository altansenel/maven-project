...
stock_trans_detail: new uml.BDDTable({
		...
		id:'stock',
        position: { x:704.5584412271571  , y: 95.44155877284291 },
		...
		id:'contact',
        position: { x:195.4415587728429  , y: 95.44155877284288 },
...
_.each(relations, function(r) { r.toBack(); });
 ...
 function saveGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		localStorage.jsonStockTransDetailGraph=(JSON.stringify(graph.toJSON()));
  	}
	else
  	{
 ...
 function loadGraph(){
	if(typeof(Storage)!=="undefined")
  	{
		 graph.fromJSON(JSON.parse(localStorage.jsonStockTransDetailGraph));
  	}
	else
  	{
  		document.getElementById("error").innerHTML="Sorry, your browser does not support web storage...";
